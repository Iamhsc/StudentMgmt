...
<body>
	<fieldset class="layui-elem-field layui-field-title"
		...
		<legend>学生信息编辑</legend>
	</fieldset>
	<form class="layui-form layui-form-pane" action="student">
		<div class="layui-form-item">
			<label class="layui-form-label">姓名</label>
			<div class="layui-input-inline">
				<input type="text" name="name" value="${stu.name}" lay-verify="required"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="stu_id" id="stu_id" value="${stu.stu_id}" lay-verify="required"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<select name="college">
					<option value="${stu.college_code}">${stu.college}</option>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<select name="professional">
					<option value="${stu.professional_code}">${stu.professional}</option>
		...
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-block">
					<input type="text" name="birthday" value="${stu.birthday}" id="date" autocomplete="off"
						class="layui-input">
				</div>
			</div>
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="radio" name="sex" value="1" title="男"  ${stu.sex==1?"checked":""}>
					<input type="radio" name="sex" value="2" title="女" ${stu.sex==2?"checked":""}>
				</div>
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="address" value="${stu.address}" lay-verify="required"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="phone" value="${stu.phone}" lay-verify="required"
					placeholder="请输入" autocomplete="off" class="layui-input">
			</div>
		</div>
		...
		<div class="layui-form-item layui-form-text">
			...
			<div class="layui-input-block">
				<textarea placeholder="请输入内容"  name="self" class="layui-textarea">${stu.self}</textarea>
			</div>
		</div>
